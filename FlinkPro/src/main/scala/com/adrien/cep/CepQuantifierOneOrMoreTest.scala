...
object CepQuantifierOneOrMoreTest  extends App {
  ...
  2,xx,100》 触发 1
CepQuantifierOneOrMoreTest:7> Record(1,小红0,20),Record(2,xx,100)
  1,小红1,20 触发 2 触发 3
  1,小红2,20  触发 2 触发 3
  2,xx,200 》 触发 2 触发 3
CepQuantifierOneOrMoreTest:8> Record(1,小红0,20),Record(2,xx,200)
CepQuantifierOneOrMoreTest:10> Record(1,小红2,20),Record(2,xx,200)
CepQuantifierOneOrMoreTest:9> Record(1,小红1,20),Record(2,xx,200)

  1,小红3,20 触发 3
  1,小红4,20 触发 3
  1,小红5,20 触发 3
  2,xx,300》 触发 3
CepQuantifierOneOrMoreTest:1> Record(1,小红2,20),Record(2,xx,300)
CepQuantifierOneOrMoreTest:12> Record(1,小红1,20),Record(2,xx,300)
CepQuantifierOneOrMoreTest:11> Record(1,小红0,20),Record(2,xx,300)
CepQuantifierOneOrMoreTest:4> Record(1,小红5,20),Record(2,xx,300)
CepQuantifierOneOrMoreTest:2> Record(1,小红3,20),Record(2,xx,300)
CepQuantifierOneOrMoreTest:3> Record(1,小红4,20),Record(2,xx,300)
   */
