...
object Data2MysqlForeach {
  def main(args: Array[String]): Unit = {
    ...
    //3、读取数据文件
    val data: RDD[String] = sparkContext.textFile("/Users/luohaotian/Downloads/person.txt")
    //4、切分每一行    // id  name  age
    ...
    personRDD.foreach(line => {
      ...
      //把数据插入到mysql表操作
      //1、获取连接
      val connection: Connection = DriverManager.getConnection("jdbc:mysql://hadoop101:3306/spark?useUnicode=true&characterEncoding=utf8","root","123123")
      //2、定义插入数据的sql语句
